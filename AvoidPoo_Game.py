...
# 배경 만들기
background = pygame.image.load("Pygame_AvoidPoo\img\white.png")

# 캐릭터 만들기
character = pygame.image.load("Pygame_AvoidPoo\img\man.png")
...
# 똥 만들기
poo = pygame.image.load("Pygame_AvoidPoo\img\poo.png")
