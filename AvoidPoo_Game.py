...
# 배경 만들기
background = pygame.image.load("C:\\doit-python\\pygame_basic\\white.png")

# 캐릭터 만들기
character = pygame.image.load("C:\doit-python\pygame_basic\man.png")
...
# 똥 만들기
poo = pygame.image.load("C:\\doit-python\\pygame_basic\\poo.png")
